...
class MainWindow(CTk):
    def __init__(self):
        ...
        # Server settings (замени на свой TCP-сервер, если есть; для Railway — нужен отдельный)
        self.server_host = "chat-production-ced1.up.railway.app"  # Твой хост
        self.server_port = 54321  # Твой порт
